...
{
	public class TSChemicalMissilePowerInfo : SupportPowerInfo
	{
		[WeaponReference]
		[FieldLoader.Require]
	...
	sealed class TSChemicalMissilePower : SupportPower
	{
		readonly TSChemicalMissilePowerInfo info;
		BodyOrientation body;

		public TSChemicalMissilePower(Actor self, TSChemicalMissilePowerInfo info)
			: base(self, info)
		{
			this.info = info;
		}
		...
		{
			self.World.OrderGenerator = new TSSelectChemicalMissilePowerTarget(order, manager, info);
		}
	}

	public class TSSelectChemicalMissilePowerTarget : SelectGenericPowerTarget
	{
		readonly TSChemicalMissilePowerInfo info;

		public TSSelectChemicalMissilePowerTarget(string order, SupportPowerManager manager, TSChemicalMissilePowerInfo info)
