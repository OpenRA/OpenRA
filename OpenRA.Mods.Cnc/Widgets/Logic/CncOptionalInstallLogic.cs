...
{
	public class CncOptionalInstallMenuLogic
	{
		public static int ContentID = 0;

		[ObjectCreator.UseCtor]
		public CncOptionalInstallMenuLogic(Widget widget)
		{
			...
			contentdropdown.OnMouseDown = _ =>
				{
					var options = new List<DropDownOption>
					{
						...
						new DropDownOption
						{
							...
							OnClick = () =>
								{
									contentdropdown.GetText = () => "Covert Operations Disc";
									ContentID = 2;
									panel.Get<ButtonWidget>("INSTALL_BUTTON").Disabled = false;
								}
						}
			...
			panel.Get<ButtonWidget>("INSTALL_BUTTON").OnClick = () =>
				{
					switch (ContentID)
					{
						...
						case 1:
							...
							break;
						case 2:
							Ui.OpenWindow("INSTALL_FROMCD_COVERTOPS_PANEL");
							break;
						default:
							break;
					}
