...
WHITELISTED_THIRDPARTY_ASSEMBLIES = ICSharpCode.SharpZipLib.dll FuzzyLogicLibrary.dll MaxMind.Db.dll Eluant.dll rix0rrr.BeaconLib.dll System.Data.HashFunction.Core.dll System.Data.HashFunction.Interfaces.dll System.Data.HashFunction.xxHash.dll Open.Nat.dll SDL2-CS.dll OpenAL-CS.dll 
...
install-engine:
	...
	@$(INSTALL_PROGRAM) System.Data.HashFunction.Core.dll "$(DATA_INSTALL_DIR)"
	@$(INSTALL_PROGRAM) System.Data.HashFunction.Interfaces.dll "$(DATA_INSTALL_DIR)"
	@$(INSTALL_PROGRAM) System.Data.HashFunction.xxHash.dll "$(DATA_INSTALL_DIR)"
