...
SuperTankDomeInfiltrated = function()
	...
	Trigger.AfterDelay(DateTime.Seconds(2), function()
		...
		Trigger.AfterDelay(DateTime.Seconds(4), function()
			Media.DisplayMessage(UserInterface.String("super-tank-self-destruct-t-minus-3"))
...
Tick = function()
	...
	if Ticked > 0 then
		if (Ticked % DateTime.Seconds(1)) == 0 then
			Timer = UserInterface.String("super-tank-self-destruct-in", { ["time"] = Utils.FormatTime(Ticked) })
...
FinishTimer = function()
	for i = 0, 9, 1 do
		...
		Trigger.AfterDelay(DateTime.Seconds(i), function() UserInterface.SetMissionText(UserInterface.String("super-tanks-destroyed"), c) end)
	end
...
AddObjectives = function()
	...
	Trigger.OnPlayerWon(Greece, function()
		Media.DisplayMessage(UserInterface.String("demitri-extracted-super-tanks-destroyed"))
