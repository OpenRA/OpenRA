...
Tick = function()
	...
	if Ticked > 0 then
		...
		if (Ticked % DateTime.Seconds(1)) == 0 then
			Timer = UserInterface.String("french-reinforcements-arrive-in", { ["time"] = Utils.FormatTime(Ticked) })
...
FrenchAlliesArrived = UserInterface.String("french-allies-arrived")
...
AddObjectives = function()
	...
	Media.DisplayMessage(UserInterface.String("soviets-blocking-gps"))
	...
	Trigger.OnPlayerWon(Allies, function()
		Media.DisplayMessage(UserInterface.String("french-survived-dismantled-soviet-presence"))
	end)
end
