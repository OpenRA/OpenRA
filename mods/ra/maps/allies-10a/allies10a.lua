...
MissionTriggers = function()
	...
	Trigger.OnTimerExpired(function()
		...
		Trigger.AfterDelay(1, function() UserInterface.SetMissionText(UserInterface.String("we-are-too-late"), USSR.Color) end)
		USSR.MarkCompletedObjective(HoldOut)
	end)
...
LaunchMissiles = function()
	...
	Trigger.AfterDelay(DateTime.Seconds(3), function()
		Media.DisplayMessage(UserInterface.String("incoming-transmission-capitalized"), UserInterface.String("landcom-16-capitalized"))
		Media.PlaySpeechNotification(Greece, "AbombLaunchDetected")
	...
	Trigger.AfterDelay(DateTime.Seconds(8), function()
		...
		Media.PlayMovieFullscreen("ally10b.vqa", function()
			...
			if fmvStart == DateTime.GameTime then
				Media.DisplayMessage(UserInterface.String("deactivate-four-missiles"), UserInterface.String("landcom-16-capitalized"))
			end
		end)
	end)
