...
ConsoleTriggers = function()
	Trigger.OnEnteredProximityTrigger(Terminal1.CenterPosition, WDist.FromCells(1), function(actor, id)
		if actor.Owner == Greece then
			...
			if not FlameTower1.IsDead then
				Media.DisplayMessage(UserInterface.String("flame-turret-deactivated"), UserInterface.String("console"))
				FlameTower1.Kill()
			end
		end
	end)
	...
	Trigger.OnEnteredProximityTrigger(Terminal4.CenterPosition, WDist.FromCells(1), function(actor, id)
		if actor.Owner == Greece and not gasActive then
			...
			Media.DisplayMessage(UserInterface.String("sarin-dispenser-activated"), UserInterface.String("console"))
	...
	Trigger.OnEnteredProximityTrigger(Terminal5.CenterPosition, WDist.FromCells(1), function(actor, id)
		if actor.Owner == Greece then
			...
			if not BadCoil.IsDead then
				Media.DisplayMessage(UserInterface.String("tesla-coil-deactivated"), UserInterface.String("console"))
				BadCoil.Kill()
			end
		end
	end)
	...
	Trigger.OnEnteredProximityTrigger(Terminal6.CenterPosition, WDist.FromCells(1), function(actor, id)
		if actor.Owner == Greece and not teslaActive then
			...
			Media.DisplayMessage(UserInterface.String("tesla-coil-activated"), UserInterface.String("console"))
...
PrisonEscape = function()
	...
	Trigger.OnEnteredFootprint(PrisonAlarm, function(unit, id)
		...
		Media.DisplayMessage(UserInterface.String("prisoners-escaping"), UserInterface.String("intercom"))
...
ScientistExecution = function()
	...
	Media.DisplayMessage(UserInterface.String("hurry-base-compromised"), UserInterface.String("soviet-officer"))
	...
	Trigger.AfterDelay(DateTime.Seconds(7), function()
		if not Officer2.IsDead then
			Media.DisplayMessage(UserInterface.String("prepare-to-fire"), UserInterface.String("soviet-officer"))
		end
	end)

	Trigger.AfterDelay(DateTime.Seconds(15), function()
		if not Officer2.IsDead then
			Media.DisplayMessage(UserInterface.String("fire"), UserInterface.String("soviet-officer"))
		end
...
ScientistRescued = function()
	Media.DisplayMessage(UserInterface.String("thanks-for-rescue"), UserInterface.String("scientist"))

	Trigger.AfterDelay(DateTime.Seconds(5), function()
		if not ScientistMan.IsDead and not DemoTruck.IsDead then
			Media.DisplayMessage(UserInterface.String("move-nuclear-outside"), UserInterface.String("scientist"))
...
DemoTruckExit = function()
	...
	Media.DisplayMessage(UserInterface.String("exit-clear-hopefully"), UserInterface.String("scientist"))
