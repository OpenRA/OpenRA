...
SetCivilianEvacuatedText = function()
	local civiliansEvacuated = UserInterface.FluentMessage("civilians-evacuated",
...
EvacuateCivilians = function()
	...
	Trigger.OnAllKilled(enemyBase, function()
		...
		Media.DisplayMessage(UserInterface.FluentMessage("chinook-assist-evacuation"), UserInterface.FluentMessage("chinook-pilot"))
