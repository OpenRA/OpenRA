...
Expand = function()
	...
	Media.DisplayMessage(UserInterface.String("allied-mcv-island"))
...
WorldLoaded = function()
	...
	Trigger.OnCapture(RadarDome, function()
		...
		if Difficulty == "easy" then
			...
			Media.DisplayMessage(UserInterface.String("allied-expansion-movement-detected"))
		else
			Actor.Create("MCV.CAM", true, { Owner = USSR, Location = MCVDeploy.Location })
			Media.DisplayMessage(UserInterface.String("coordinates-allied-expansion-discovered"))
		end
