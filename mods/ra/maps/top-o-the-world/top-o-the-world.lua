...
--Objectives Setup
	...
	Trigger.OnAllKilled(AlliedAAGuns, function()
		...
		Trigger.AfterDelay(DateTime.Seconds(2), function()
			...
			Media.DisplayMessage(UserInterface.FluentMessage("air-support-t-minus-3"))
		end)
  end)
...
--Triggers Setup
	...
	Trigger.AfterDelay(0, function()
		...
		Trigger.OnKilled(BridgeEnd, function()
			...
			Media.PlaySpeechNotification(USSR, "ObjectiveMet")
			Trigger.AfterDelay(DateTime.Seconds(2), function()
				Media.DisplayMessage(UserInterface.FluentMessage("allied-ground-reinforcements-stopped"))
			end)
		end)
	end)
