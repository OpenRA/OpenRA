...
SetEvacuateMissionText = function()
	local unitsEvacuated = UserInterface.String("units-evacuated",
...
WorldLoaded = function()
	...
	Utils.Do(Humans, function(player)
		if player then
			EvacuateUnits = AddPrimaryObjective(player, UserInterface.String("evacuate-units", { ["threshold"] = UnitsEvacuatedThreshold[Difficulty] }))
	...
	if not Allies2 then
		Allies1.Cash = 10000
		Media.DisplayMessage(UserInterface.String("transferring-funds"), UserInterface.String("co-commander-missing"))
	end
