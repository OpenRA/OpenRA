...
Tick = function()
	...
	if Ticked > 0 then
		if (Ticked % DateTime.Seconds(1)) == 0 then
			Timer = UserInterface.FluentMessage("soviet-reinforcements-arrive-in", { ["time"] = Utils.FormatTime(Ticked) })
...
FinalAttack = function()
	...
	Trigger.OnAllKilledOrCaptured(units, function()
		if not DestroyObj then
			Media.DisplayMessage(UserInterface.FluentMessage("reinforced-position-initiate-counter-attack"), UserInterface.FluentMessage("incoming-report"))
...
SovietReinforcementsArrived = UserInterface.FluentMessage("soviet-reinforcements-arrived")
...
SetupBridges = function()
	...
	Media.DisplayMessage(UserInterface.FluentMessage("repair-bridges-for-reinforcement"), UserInterface.FluentMessage("incoming-report"))
...
AddObjectives = function()
	...
	Trigger.OnPlayerWon(Allies, function()
		Media.DisplayMessage(UserInterface.FluentMessage("remaining-soviet-presence-destroyed"), UserInterface.FluentMessage("incoming-report"))
	end)
end
...
InitMission = function()
	...
	Trigger.AfterDelay(TimerTicks, function()
		Media.DisplayMessage(UserInterface.FluentMessage("soviet-reinforcements-approaching"), UserInterface.FluentMessage("incoming-report"))
