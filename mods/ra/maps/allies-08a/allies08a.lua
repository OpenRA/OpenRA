...
DefendChronosphereCompleted = function()
	...
	UserInterface.SetMissionText(UserInterface.String("experiment-successful"), Greece.Color)
...
Tick = function()
	...
	if Ticked > 0 then
		if (Ticked % DateTime.Seconds(1)) == 0 then
			Timer = UserInterface.String("chronosphere-experiment-complete-in", { ["time"] = Utils.FormatTime(Ticked) })
