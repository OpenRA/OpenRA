...
Tick = function()
	...
	local text = UserInterface.String("hostage-dies-in", { ["time"] = Utils.FormatTime(TimeRemaining) })
	UserInterface.SetMissionText(text, TimerColor)
end

PrepareCountdown = function(interval)
	local text = UserInterface.String("hostage-dies-in", { ["time"] = Utils.FormatTime(interval) })
	UserInterface.SetMissionText(text, TimerColor)
...
PrepareForestEncounter = function()
	...
	Trigger.OnExitedFootprint({ ForestHideout.Location }, function(actor, id)
		...
		Trigger.RemoveFootprintTrigger(id)
		Media.DisplayMessage(UserInterface.String("guide-follow-me"), actor.TooltipName)
	end)
...
GuideToForest = function(guide)
	...
	guide.CallFunc(function()
		Media.DisplayMessage(UserInterface.String("guide-thank-you"), guide.TooltipName)
	end)
...
GuideToHideout = function(guide)
	...
	guide.CallFunc(function()
		Media.DisplayMessage(UserInterface.String("guide-patrol-coming"), guide.TooltipName)
	end)
	...
	guide.CallFunc(function()
		...
		Media.DisplayMessage(UserInterface.String("guide-come-this-way"), guide.TooltipName)
...
GuideToVillage = function(guide, patrolKilled)
	...
	Media.DisplayMessage(UserInterface.String("guide-safe-to-move"), guide.TooltipName)
...
OnAllHostagesKilled = function()
	...
	Media.DisplayMessage(UserInterface.String("all-hostages-killed"))
...
OnChurchKilled = function()
	Media.PlaySoundNotification(Greece, "AlertBleep")
	Media.DisplayMessage(UserInterface.String("church-destroyed"))
