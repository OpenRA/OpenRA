	...
	Utils.Do(AtreidesUnits, function(unit)
		Trigger.OnDamaged(unit, function(self, attacker)
			if attacker.Owner == Harkonnen and not Check then
				...
				Check = true
				Media.DisplayMessage(UserInterface.String("atreides-hostile"), Mentat)
			end
		end)
	end)
end
...
Tick = function()
	...
	if Ordos.HasNoRequiredUnits() and not Harkonnen.IsObjectiveCompleted(KillOrdos) then
		Media.DisplayMessage(UserInterface.String("ordos-annihilated"), Mentat)
	...
	if MercenaryEnemy.HasNoRequiredUnits() and MercenaryAlly.HasNoRequiredUnits() and not MercenariesDestroyed then
		Media.DisplayMessage(UserInterface.String("mercenaries-annihilated"), Mentat)
...
WorldLoaded = function()
	...
	Trigger.OnCapture(MHeavyFactory, function()
		...
		Media.DisplayMessage(UserInterface.String("mercenary-leader-captured-allied"), Mentat)
	...
	Trigger.OnKilledOrCaptured(OPalace, function()
		Media.DisplayMessage(UserInterface.String("can-not-stand-harkonnen-must-become-neutral"), UserInterface.String("atreides-commander"))
