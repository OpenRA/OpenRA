...
ActivateAI = function()
	Defending[Atreides] = { }
	Defending[Harkonnen] = { }
	AttackDelay[Atreides] = 12000 * DifficultyModifier[Difficulty]
	AttackDelay[Harkonnen] = 10000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[Atreides] = 8000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[Harkonnen] = 9000 * DifficultyModifier[Difficulty]
	HarvesterCount[Atreides] = 2
	HarvesterCount[Harkonnen] = 2
	PatrolPoints[Atreides] = { APatrolPoint1.Location, APatrolPoint2.Location, APatrolPoint3.Location, APatrolPoint4.Location, AtreidesRally2.Location }
	PatrolPoints[Harkonnen] = { HPatrolPoint1.Location, HPatrolPoint2.Location, HPatrolPoint3.Location }
	DefencePerimeter[Atreides] = GetCellsInRectangle(CPos.New(25,2), CPos.New(60,15))
	DefencePerimeter[Harkonnen] = Utils.Concat(GetCellsInRectangle(CPos.New(66,75), CPos.New(81,88)), GetCellsInRectangle(CPos.New(50,86), CPos.New(64,89)))
	...
	local attackThresholdSize = AttackGroupSize[Difficulty] * 2.5
		...
		ProduceUnits(Atreides, ABarracks2, delay, infantryToBuild, AttackGroupSize[Difficulty], attackThresholdSize)
