...
Tick = function()
	...
	if not Sietch.IsDead then
		...
		SiegeIntegrity = UserInterface.String("sietch-integrity", { ["integrity"] = integrity })
...
WorldLoaded = function()
	...
	local keepSietchIntact = UserInterface.String("keep-sietch-intact", { ["integrity"] = IntegrityLevel[Difficulty] })
	...
	Trigger.AfterDelay(DateTime.Seconds(2), function()
		...
		Media.DisplayMessage(UserInterface.String("fremen-sietch-southeast"), Mentat)
	end)
	...
	Trigger.OnKilled(Sietch, function()
		...
		UserInterface.SetMissionText(UserInterface.String("sietch-destroyed"), Atreides.Color)
	...
	Trigger.OnDamaged(Sietch, function()
		if AttackNotifier <= 0 then
			...
			Media.DisplayMessage(UserInterface.String("fremen-sietch-under-attack"), Mentat)
