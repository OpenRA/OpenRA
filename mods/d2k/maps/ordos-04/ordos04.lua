...
WorldLoaded = function()
	...
	Trigger.OnDamaged(SOutpost, function(_, attacker)
		...
		if AttackNotifier <= 0 then
			...
			Media.DisplayMessage(UserInterface.String("do-not-destroy-outpost"), Mentat)
		end
	end)
	...
	Trigger.AfterDelay(HarkonnenAttackDelay[Difficulty], function()
		Media.DisplayMessage(UserInterface.String("warning-large-force-approaching"), Mentat)
	end)
end
