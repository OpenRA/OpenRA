...
ActivateAI = function()
	...
	TimeBetweenAttacks[Atreides] = 7000 * DifficultyModifier[Difficulty]
	AttackDelay[Harkonnen] = 7000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[Harkonnen] = 4000 * DifficultyModifier[Difficulty]
	AttackDelay[Corrino] = 5000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[Corrino] = 6000 * DifficultyModifier[Difficulty]
	AttackDelay[Mercenaries] = 5000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[Mercenaries] = 5500 * DifficultyModifier[Difficulty]
	AttackDelay[CorrinoSmall] = 5000 * DifficultyModifier[Difficulty]
	TimeBetweenAttacks[CorrinoSmall] = 5500 * DifficultyModifier[Difficulty]
	HarvesterCount[Atreides] = 4
	HarvesterCount[Harkonnen] = 4
	HarvesterCount[Corrino] = 2
	HarvesterCount[Mercenaries] = 2
	HarvesterCount[CorrinoSmall] = 0
	...
	LastHarvesterEaten[CorrinoSmall] = true

	PatrolPoints[Atreides] = { APatrolPoint1.Location, APatrolPoint2.Location, APatrolPoint3.Location, AReinforcementsPoint3.Location}
	PatrolPoints[Harkonnen] = { HPatrolPoint1.Location, HPatrolPoint2.Location, HPatrolPoint3.Location}
	PatrolPoints[Mercenaries] = { MPatrolPoint1.Location, HReinforcementsPoint2.Location, AReinforcementsPoint1.Location, MPatrolPoint2.Location}
	PatrolPoints[Corrino] = { CPatrolPoint1.Location, AReinforcementsPoint1.Location, HPatrolPoint3.Location }


	DefencePerimeter[Atreides] = Utils.Concat(GetCellsInRectangle(CPos.New(67,70), CPos.New(84,91)), GetCellsInRectangle(CPos.New(85,77), CPos.New(98,80)))
	DefencePerimeter[Harkonnen] = Utils.Concat(GetCellsInRectangle(CPos.New(20,68), CPos.New(45,90)), GetCellsInRectangle(CPos.New(47,65), CPos.New(58,90)))

	DefencePerimeter[Corrino] = Utils.Concat(GetCellsInRectangle(CPos.New(53,43), CPos.New(64,60)), GetCellsInRectangle(CPos.New(70,48), CPos.New(80,56)))
	DefencePerimeter[Mercenaries] = GetCellsInRectangle(CPos.New(2,33), CPos.New(15,49))
	DefencePerimeter[CorrinoSmall] = GetCellsInRectangle(CPos.New(11,79), CPos.New(22,91))
	...
	IdlingUnits[CorrinoSmall] = Reinforcements.Reinforce(CorrinoSmall,InitialReinforcementsSquads[6], InitialSpawnPaths[6])
	...
	Trigger.AfterDelay(150, function()
		ProduceUnits(Harkonnen, HHeavyFactory1, delay, tanksToBuildHarkonnen, AttackGroupSize[Difficulty], attackThresholdSize)
		ProduceUnits(Harkonnen, HHeavyFactory2, delay, tanksToBuildHarkonnen, AttackGroupSize[Difficulty], attackThresholdSize)
	end)

	ProduceUnits(Corrino, CBarracks1, delay, infantryToBuild, AttackGroupSize[Difficulty], attackThresholdSize)
	ProduceUnits(Corrino, CHeavyFactory, delay, tanksToBuildCorrino, AttackGroupSize[Difficulty], attackThresholdSize)

	ProduceUnits(CorrinoSmall, CBarracks2, delay, infantryToBuildCorrino, AttackGroupSize[Difficulty], attackThresholdSize)
	...
	if Difficulty == "normal" then
		...
		Corrino.GrantCondition("base-rebuilder3")
	end
