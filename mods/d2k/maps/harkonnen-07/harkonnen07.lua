...
Tick = function()
	...
	if (AHiTechFactory.IsDead or AHiTechFactory.Owner ~= AtreidesMain) and not HiTechIsDead then
		Media.DisplayMessage(UserInterface.String("high-tech-factory-neutralized-imperial-reinforcements"), Mentat)
		HiTechIsDead = true
	end
...
WorldLoaded = function()
	...
	Media.DisplayMessage(UserInterface.String("destroy-atreides-high-tech-factory-imperial-reinforcements"), Mentat)
