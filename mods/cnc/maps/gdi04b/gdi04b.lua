		...
		Trigger.OnAllKilled(team, function()
			if GDIReinforcementsLeft > 0 then
				...
				Trigger.AfterDelay(DateTime.Seconds(5), function()
					Media.DisplayMessage(UserInterface.String("apcs-left", { ["apcs"] = GDIReinforcementsLeft }), UserInterface.String("battlefield-control"))
					SendGDIReinforcements()
				end)
			end
		end)
...
WorldLoaded = function()
	...
	local eliminateReinforcements = UserInterface.String("eliminate-reinforcements", { ["kills"] = KillsUntilReinforcements })
