...
RunForHelp = function()
	if not CivsRunning then
		...
		Media.DisplayMessage(UserInterface.String("civilians-running"), UserInterface.String("nod-soldier"))
	end
end
...
CheckVillageDestruction = function()
	...
	if CivsBuildingsToDestroy == 2 then
		Media.DisplayMessage(UserInterface.String("village-destruction-warning"))
