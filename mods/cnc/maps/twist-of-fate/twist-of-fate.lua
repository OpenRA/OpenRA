...
CompleteCaptureCommCenterObjective = function()
	...
	Media.DisplayMessage(UserInterface.String("communications-center-captured-sams-located"))
	...
	Trigger.AfterDelay(DateTime.Seconds(AstkDelay), function()
		if AstkDelay > 0 then
			...
			Trigger.AfterDelay(DateTime.Seconds(15), function()
				Media.DisplayMessage(UserInterface.String("air-strikes-intel-report"))
				Trigger.AfterDelay(DateTime.Seconds(8), function()
