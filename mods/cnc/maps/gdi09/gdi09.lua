...
SpawnGunboat = function()
	Media.PlaySpeechNotification(GDI, "Reinforce")
	Actor.Create("boat", true, { Owner = GDI, Facing = 0, Location = waypoint23.Location })
end
...
WorldLoaded = function()
	...
	AirSupport = GDI.AddSecondaryObjective("Destroy the SAM sites to receive air support.")
