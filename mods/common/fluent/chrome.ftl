...
label-editor-opposites-island = Island
label-editor-opposites-ring = Ring
button-editor-train-opposite-island = Train Opposite Island
button-editor-train-opposite-ring = Train Opposite Ring
...
label-editor-metadata-pick-primary = Pick a tile in the list below
button-editor-train-island-short = Isl
button-editor-train-ring-short = Ring
button-editor-train-similar-short = Sim
button-editor-train-orientation-island-short = Ori I
button-editor-train-orientation-ring-short = Ori R
button-editor-metadata-db-short = DB
label-editor-tile-metadata-database = Training Page
button-save = Save
label-editor-metadata-templates = Templates
label-editor-metadata-actors = Actors
label-editor-orientation-training = Pick orientation slot
label-editor-metadata-pick = Pick
button-similar-preview-previous = <
button-similar-preview-next = >
button-editor-show-similar = Show Similar
button-editor-clear-similar = Clear Similar
