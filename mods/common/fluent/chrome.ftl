...
label-paint-brush-type = Type
button-tiling-path-paint = Paint tiling to map
label-paint-brush-brush-options = Brush Options
label-paint-brush-size = Brush Size
label-paint-brush-flood-limit = Flood Limit
label-paint-brush-paint-options = Paint Options
label-paint-brush-owner = Owner
label-paint-brush-filter-terrain = Filter Terrain
label-paint-brush-filter-actors = Filter Actors
label-paint-brush-filter-subcell-actors = Filter Subcell Actors
label-paint-brush-adapt-height = Adapt Height
label-paint-brush-flood-terrain = Flood By
label-paint-brush-flood-ignore-actors = Flood Ignores Actors
label-paint-brush-flood-ignore-height = Flood Ignores Height
label-paint-brush-sparsity = Sparsity
