...
label-streamer-section-header = Streamer Mode
checkbox-sanitize-muted-players-container = Replace muted player names with colors
checkbox-sanitize-all-players-container = Replace all player names with colors
