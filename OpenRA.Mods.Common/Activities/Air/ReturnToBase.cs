...
namespace OpenRA.Mods.Common.Activities
{
	...
	{
		const int TooCloseDestinationThreshold = 5000;
		...
		public override Activity Tick(Actor self)
		{
			...
			//// ignore destination generated by Calculate() if they are too close to self
			List<Activity> landingProcedures = new List<Activity>();

			var w1DistanceFromSelf = (w1 - self.CenterPosition).HorizontalLength;
			...
			landingProcedures.Add(new Fly(self, Target.FromPos(w3)));
