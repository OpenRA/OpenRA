...
namespace OpenRA.Mods.Common.Widgets.Logic
{
	public static class ReplayUtils
	{
		...
		public static bool PromptConfirmReplayCompatibility(ChromeLogic.DynamicWidgets dynamicWidgets, ReplayMetadata replayMeta, ModData modData, Action onCancel = null)
		{
			onCancel ??= DoNothing;
		...
		static bool IncompatibleReplayDialog(ChromeLogic.DynamicWidgets dynamicWidgets, string text, Dictionary<string, object> textArguments, ModData modData, Action onCancel)
		{
			ConfirmationDialogs.ButtonPrompt(dynamicWidgets, modData, IncompatibleReplayTitle, text, textArguments: textArguments, onCancel: onCancel, cancelText: IncompatibleReplayAccept);
			return false;
		}
	}
}
