...
namespace OpenRA.Mods.Common.Widgets.Logic
{
	public class DownloadPackageLogic : ChromeLogic
	{
		...
		void ShowDownloadDialog()
		{
			...
			void OnDownloadProgress(long total, long read, int progress)
			{
				...
				else
				{
					...
					getStatusText = () => "Downloading from {4} {1:0.00}/{2:0.00} {3} ({0}%)".F(progress, dataReceived, dataTotal, dataSuffix, downloadHost ?? "unknown host");
