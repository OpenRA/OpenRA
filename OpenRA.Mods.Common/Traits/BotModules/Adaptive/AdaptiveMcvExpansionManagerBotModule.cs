...
namespace OpenRA.Mods.Common.Traits
{
	...
	[Desc("Manages Adaptive AI MCVs and expansion.")]
	public class AdaptiveMcvExpansionManagerBotModuleInfo : ConditionalTraitInfo, Requires<AdaptiveResourceMapBotModuleInfo>, NotBefore<AdaptiveResourceMapBotModuleInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new AdaptiveMcvExpansionManagerBotModule(init.Self, this); }
	}

	public class AdaptiveMcvExpansionManagerBotModule :
		ConditionalTrait<AdaptiveMcvExpansionManagerBotModuleInfo>,
		IBotTick,
		IBotRespondToAttack,
		IBotBaseExpansion,
		INotifyActorDisposing
	{
		...
		AdaptiveResourceMapBotModule resourceMapModule;
		...
		public AdaptiveMcvExpansionManagerBotModule(Actor self, AdaptiveMcvExpansionManagerBotModuleInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
		...
		void IBotTick.BotTick(IBot bot)
		{
			...
			if (firstTick)
			{
				resourceMapModule = bot.Player.PlayerActor.TraitsImplementing<AdaptiveResourceMapBotModule>().FirstOrDefault(t => t.IsTraitEnabled());
