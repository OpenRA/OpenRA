...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class HarvesterBotModuleInfo : ConditionalTraitInfo, IBotModuleInfo
	{
		[Desc("Name for identification purposes.")]
		public readonly string Name = "harvester-module";
	...
	public class HarvesterBotModule : ConditionalTrait<HarvesterBotModuleInfo>, IBotModule
	{
		...
		void IBotModule.Tick()
		{
			...
			// Find new harvesters
			var newHarvesters = world.ActorsHavingTrait<Harvester>().Where(a => a.Owner == ai.Player && !harvesters.Contains(a));
