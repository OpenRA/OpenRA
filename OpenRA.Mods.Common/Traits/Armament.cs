...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class ArmamentInfo : UpgradableTraitInfo, IRulesetLoaded, Requires<AttackBaseInfo>
	{
		...
		[Desc("Ignore any custom targetable positions and always aim at the target's CenterPosition.")]
		public readonly bool IgnoreTargetOffset = false;
	...
	public class Armament : UpgradableTrait<ArmamentInfo>, INotifyCreated, ITick, IExplodeModifier
	{
		...
		public Barrel CheckFire(Actor self, IFacing facing, Target target)
		{
			...
			var args = new ProjectileArgs
			{
				...
				SourceActor = self,
				PassiveTarget = Info.IgnoreTargetOffset ? target.CenterPosition : target.Positions.First(),
				GuidedTarget = target
			};
