...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class WalkableTerrainOverlayInfo : TraitInfo
	{
		[Desc("Locomotor used to determine walkable terrain.")]
		public readonly string Locomotor = "foot";
		...
		{
			return new WalkableTerrainOverlay(init.Self, this);
		}
	}

	public class WalkableTerrainOverlay : IRenderAboveWorld, IRenderAnnotations, IWorldLoaded
	{
		readonly WalkableTerrainOverlayInfo info;
		...
		public WalkableTerrainOverlay(Actor self, WalkableTerrainOverlayInfo info)
		{
			this.info = info;
			world = self.World;
		...
		bool IsWalkable(CPos cell) => EditorWalkability.IsCellWalkable(world, locomotor, cell);
		...
		void IRenderAboveWorld.RenderAboveWorld(Actor self, WorldRenderer wr)
		{
			...
			EditorCellStatusOverlay.RenderCells(wr, IsWalkable, overlaySprite, overlayScale, info.Alpha, palette);
		}
