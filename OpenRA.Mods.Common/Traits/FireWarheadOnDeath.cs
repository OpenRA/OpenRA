...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class FireWarheadOnDeathInfo : ConditionalTraitInfo, Requires<IHealthInfo>
	{
		[WeaponReference]
		[FieldLoader.Require]
		...
		public override object Create(ActorInitializer init) { return new FireWarheadOnDeath(this, init.Self); }
	...
	public class FireWarheadOnDeath : ConditionalTrait<FireWarheadOnDeathInfo>, INotifyKilled, INotifyDamage
	{
		readonly IHealth health;
		BuildingInfo buildingInfo;
		Armament[] armaments;

		public FireWarheadOnDeath(FireWarheadOnDeathInfo info, Actor self)
			: base(info)
		{
