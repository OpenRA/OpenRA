...
namespace OpenRA.Mods.Common.Traits
{
	public abstract class SupportPowerInfo : PausableConditionalTraitInfo
	{
		...
		[Desc("Amount of time after spawn to remove the camera.")]
	...
	public class SupportPower : PausableConditionalTrait<SupportPowerInfo>
	{
		...
		protected Shroud.SourceType CameraRevealType()
		{
			return info.RevealGeneratedShroud ? Shroud.SourceType.Visibility : Shroud.SourceType.PassiveVisibility;
		}
