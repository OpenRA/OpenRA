	...
	public class AttackFollow : AttackBase, ITick, INotifyOwnerChanged
	{
		...
		class AttackActivity : Activity
		{
			...
			public override Activity Tick(Actor self)
			{
				...
				if (weapon != null)
				{
					var targetIsMobile = (target.Type == TargetType.Actor && target.Actor.Info.TraitInfosAny<IMoveInfo>())
						|| (target.Type == TargetType.FrozenActor && target.FrozenActor.Info.TraitInfosAny<IMoveInfo>());
