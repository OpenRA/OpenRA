		...
		public int TimeLimit
		{
			...
			set
			{
				if (tlm != null)
					...
					throw new InvalidOperationException("Cannot set TimeLimit, TimeLimitManager trait is missing.");
			}
		}
		...
		public string TimeLimitNotification
		{
			...
			set
			{
				if (tlm != null)
					...
					throw new InvalidOperationException("Cannot set TimeLimitNotification, TimeLimitManager trait is missing.");
			}
		}
	}
}
