...
namespace OpenRA.Mods.Common.Scripting
{
	...
	public class AirstrikeProperties : ScriptActorProperties, Requires<AirstrikePowerInfo>
	{
		...
		{
			TextManager.Debug("SendAirstrike is deprecated. Use TargetAirstrike instead.");
		...
		{
			TextManager.Debug("SendAirstrikeFrom is deprecated. Use TargetAirstrike instead.");
