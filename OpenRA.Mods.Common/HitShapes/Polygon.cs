...
namespace OpenRA.Mods.Common.HitShapes
{
	public class PolygonShape : IHitShape
	{
		...
		public void Initialize()
		{
			...
			OuterRadius = new WDist(Points.Select(x => x.Length).Max());
		...
		{
			var ac = c - a;
			int ac2 = ac.LengthSquared;
			int bc2 = (c - b).LengthSquared;
			...
			return (ac - ap).LengthSquared; // Length of vector pc squared.
		}
