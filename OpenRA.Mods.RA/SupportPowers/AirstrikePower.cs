...
namespace OpenRA.Mods.RA
{
	class AirstrikePowerInfo : SupportPowerInfo
	{
		...
		public override object Create(ActorInitializer init) { return new AirstrikePower(init, this); }
	}

	class AirstrikePower : SupportPower
	{
		public AirstrikePower(ActorInitializer init, AirstrikePowerInfo info)
			: base(init, info) { }
		...
		public override void Activate(Order order)
		{
			...
			var info = this.Info as AirstrikePowerInfo;
