...
namespace OpenRA.Mods.RA.Buildings
{
	...
	public class RepairableBuildingInfo : ITraitInfo, Requires<HealthInfo>
	{
		...
		public readonly int[] RepairBonuses = new int[] { 100, 150, 175, 200, 220, 240, 265, 280, 300 };
	...
	public class RepairableBuilding : ITick, ISync
	{
		...
		public void RepairBuilding(Actor self, Player player)
		{
			...
			{
				if (!Repairers.Remove(player) && Repairers.Count < Info.RepairBonuses.Length) // If the player won't affect the repair, we won't add him
				{
