...
namespace OpenRA.Mods.RA.Widgets.Logic
{
	public class SaveBrowserLogic
	{
		...
		public SaveBrowserLogic(Widget widget, Action onExit, Action onStart)
		{
		...
		void PlaySave()
		{
			...
			om = Game.JoinSave(IPAddress.Loopback.ToString(), Game.CreateLocalServer(this.selectedSave.GameInfo.MapUid), "", selectedSave.FilePath);
		}
