...
local api =
  {
  ["ASSIMP_CFLAGS_SHARED"] = { type ='value', description = "static const uint = 0x1", },
  ["ASSIMP_CFLAGS_STLPORT"] = { type ='value', description = "static const uint = 0x2", },
  ["ASSIMP_CFLAGS_DEBUG"] = { type ='value', description = "static const uint = 0x4", },
  ["ASSIMP_CFLAGS_NOBOOST"] = { type ='value', description = "static const uint = 0x8", },
  ["ASSIMP_CFLAGS_SINGLETHREADED"] = { type ='value', description = "static const uint = 0x10", },
  ["AI_TYPES_MAXLEN"] = { type ='value', description = "static const size_t = 1024", },
  ["AI_SLM_DEFAULT_MAX_TRIANGLES"] = { type ='value', description = "static const uint = 1000000", },
  ["AI_SLM_DEFAULT_MAX_VERTICES"] = { type ='value', description = "static const uint = 1000000", },
  ["AI_LMW_MAX_WEIGHTS"] = { type ='value', description = "static const uint = 0x4", },
  ["AI_UVTRAFO_SCALING"] = { type ='value', description = "static const uint = 0x1", },
  ["AI_UVTRAFO_ROTATION"] = { type ='value', description = "static const uint = 0x2", },
  ["AI_UVTRAFO_TRANSLATION"] = { type ='value', description = "static const uint = 0x4", },
  ["AI_MAX_FACE_INDICES"] = { type ='value', description = "static const uint = 0x7fff", },
  ["AI_MAX_BONE_WEIGHTS"] = { type ='value', description = "static const uint = 0x7fffffff", },
  ["AI_MAX_VERTICES"] = { type ='value', description = "static const uint = 0x7fffffff", },
  ["AI_MAX_FACES"] = { type ='value', description = "static const uint = 0x7fffffff", },
  ["AI_MAX_NUMBER_OF_COLOR_SETS"] = { type ='value', description = "static const uint = 0x4", },
  ["AI_MAX_NUMBER_OF_TEXTURECOORDS"] = { type ='value', description = "static const uint = 0x4", },
  ...
  ["aiLogStream"] = { type ='class', 
    description = "", 
    childs =     {
    ["callback"] = { type ='value', description = "aiLogStreamCallback", },
    ["user"] = { type ='value', description = "char*", },
    }
  },
  ["aiString"] = { type ='class', 
    description = "", 
    childs =     {
    ["length"] = { type ='value', description = "size_t", },
    }
  },
  ["aiMemoryInfo"] = { type ='class', 
    description = "", 
    childs =     {
    ["textures"] = { type ='value', description = "uint", },
    ["materials"] = { type ='value', description = "uint", },
    ["meshes"] = { type ='value', description = "uint", },
    ["nodes"] = { type ='value', description = "uint", },
    ["animations"] = { type ='value', description = "uint", },
    ["cameras"] = { type ='value', description = "uint", },
    ["lights"] = { type ='value', description = "uint", },
    ["total"] = { type ='value', description = "uint", },
    }
  },
  ["aiVector2D"] = { type ='class', 
    description = "", 
    childs =     {
    ["y"] = { type ='value', description = "", },
    }
  },
  ["aiVector3D"] = { type ='class', 
    description = "", 
    childs =     {
    ["z"] = { type ='value', description = "", },
    }
  },
  ...
  ["aiMatrix3x3"] = { type ='class', 
    description = "", 
    childs =     {
    ["a3"] = { type ='value', description = "", },
    ["b3"] = { type ='value', description = "", },
    ["c3"] = { type ='value', description = "", },
    }
  },
  ["aiMatrix4x4"] = { type ='class', 
    description = "", 
    childs =     {
    ["a4"] = { type ='value', description = "", },
    ["b4"] = { type ='value', description = "", },
    ["c4"] = { type ='value', description = "", },
    ["d4"] = { type ='value', description = "", },
    }
  },
  ["aiPlane"] = { type ='class', 
    description = "", 
    childs =     {
    ["a"] = { type ='value', description = "float", },
    ["b"] = { type ='value', description = "float", },
    ["c"] = { type ='value', description = "float", },
    ["d"] = { type ='value', description = "float", },
    }
  },
  ["aiRay"] = { type ='class', 
    description = "", 
    childs =     {
    ["pos"] = { type ='value', description = "aiVector3D", },
    ["dir"] = { type ='value', description = "aiVector3D", },
    }
  },
  ["aiColor3D"] = { type ='class', 
    description = "", 
    childs =     {
    ["r"] = { type ='value', description = "float", },
    ["g"] = { type ='value', description = "float", },
    ["b"] = { type ='value', description = "float", },
    }
  },
  ...
  ["aiFileIO"] = { type ='class', 
    description = "", 
    childs =     {
    ["OpenProc"] = { type ='value', description = "aiFileOpenProc", },
    ["CloseProc"] = { type ='value', description = "aiFileCloseProc", },
    ["UserData"] = { type ='value', description = "aiUserData", },
    }
  },
  ["aiFile"] = { type ='class', 
    description = "", 
    childs =     {
    ["ReadProc"] = { type ='value', description = "aiFileReadProc", },
    ["WriteProc"] = { type ='value', description = "aiFileWriteProc", },
    ["TellProc"] = { type ='value', description = "aiFileTellProc", },
    ["FileSizeProc"] = { type ='value', description = "aiFileTellProc", },
    ["SeekProc"] = { type ='value', description = "aiFileSeek", },
    ["FlushProc"] = { type ='value', description = "aiFileFlushProc", },
    ["UserData"] = { type ='value', description = "aiUserData", },
    }
  },
  ["aiLight"] = { type ='class', 
    description = "", 
    childs =     {
    ["mName"] = { type ='value', description = "aiString", },
    ["mType"] = { type ='value', description = "aiLightSourceType", },
    ["mPosition"] = { type ='value', description = "aiVector3D", },
    ["mDirection"] = { type ='value', description = "aiVector3D", },
    ["mAttenuationConstant"] = { type ='value', description = "float", },
    ["mAttenuationLinear"] = { type ='value', description = "float", },
    ["mAttenuationQuadratic"] = { type ='value', description = "float", },
    ["mColorDiffuse"] = { type ='value', description = "aiColor3D", },
    ["mColorSpecular"] = { type ='value', description = "aiColor3D", },
    ["mColorAmbient"] = { type ='value', description = "aiColor3D", },
    ["mAngleInnerCone"] = { type ='value', description = "float", },
    ["mAngleOuterCone"] = { type ='value', description = "float", },
    }
  },
  ["aiCamera"] = { type ='class', 
    description = "", 
    ...
    ["mName"] = { type ='value', description = "aiString", },
    ["mPosition"] = { type ='value', description = "aiVector3D", },
    ["mUp"] = { type ='value', description = "aiVector3D", },
    ["mLookAt"] = { type ='value', description = "aiVector3D", },
    ["mHorizontalFOV"] = { type ='value', description = "float", },
    ["mClipPlaneNear"] = { type ='value', description = "float", },
    ["mClipPlaneFar"] = { type ='value', description = "float", },
    ["mAspect"] = { type ='value', description = "float", },
    }
  },
  ["aiVectorKey"] = { type ='class', 
    description = "", 
    childs =     {
    ["mTime"] = { type ='value', description = "double", },
    ["mValue"] = { type ='value', description = "aiVector3D", },
    }
  },
  ["aiQuatKey"] = { type ='class', 
    ...
    childs =     {
    ["mTime"] = { type ='value', description = "double", },
    ["mValue"] = { type ='value', description = "aiQuaternion", },
    }
  },
  ["aiNodeAnim"] = { type ='class', 
    description = "", 
    childs =     {
    ["mNodeName"] = { type ='value', description = "aiString", },
    ["mNumPositionKeys"] = { type ='value', description = "uint", },
    ["mPositionKeys"] = { type ='value', description = "aiVectorKey*", },
    ["mNumRotationKeys"] = { type ='value', description = "uint", },
    ["mRotationKeys"] = { type ='value', description = "aiQuatKey*", },
    ["mNumScalingKeys"] = { type ='value', description = "uint", },
    ["mScalingKeys"] = { type ='value', description = "aiVectorKey*", },
    ["mPreState"] = { type ='value', description = "aiAnimBehaviour", },
    ["mPostState"] = { type ='value', description = "aiAnimBehaviour", },
    }
  },
  ["aiAnimation"] = { type ='class', 
    ...
    childs =     {
    ["mName"] = { type ='value', description = "aiString", },
    ["mDuration"] = { type ='value', description = "double", },
    ["mTicksPerSecond"] = { type ='value', description = "double", },
    ["mNumChannels"] = { type ='value', description = "uint", },
    ["mChannels"] = { type ='value', description = "aiNodeAnim**", },
    }
  },
  ["aiFace"] = { type ='class', 
    description = "", 
    childs =     {
    ["mNumIndices"] = { type ='value', description = "uint", },
    ["mIndices"] = { type ='value', description = "uint*", },
    }
  },
  ["aiVertexWeight"] = { type ='class', 
    description = "", 
    childs =     {
    ["mVertexId"] = { type ='value', description = "uint", },
    ["mWeight"] = { type ='value', description = "float", },
    }
  },
  ["aiBone"] = { type ='class', 
    description = "", 
    childs =     {
    ["mName"] = { type ='value', description = "aiString", },
    ["mNumWeights"] = { type ='value', description = "uint", },
    ["mWeights"] = { type ='value', description = "aiVertexWeight*", },
    ["mOffsetMatrix"] = { type ='value', description = "aiMatrix4x4", },
    }
  },
  ["aiAnimMesh"] = { type ='class', 
    description = "", 
    childs =     {
    ["mVertices"] = { type ='value', description = "aiVector3D*", },
    ["mNormals"] = { type ='value', description = "aiVector3D*", },
    ["mTangents"] = { type ='value', description = "aiVector3D*", },
    ["mBitangents"] = { type ='value', description = "aiVector3D*", },
    ["mNumVertices"] = { type ='value', description = "uint", },
    }
  },
  ["aiMesh"] = { type ='class', 
    description = "", 
    childs =     {
    ["mPrimitiveTypes"] = { type ='value', description = "uint", },
    ["mNumVertices"] = { type ='value', description = "uint", },
    ["mNumFaces"] = { type ='value', description = "uint", },
    ["mVertices"] = { type ='value', description = "aiVector3D*", },
    ["mNormals"] = { type ='value', description = "aiVector3D*", },
    ["mTangents"] = { type ='value', description = "aiVector3D*", },
    ["mBitangents"] = { type ='value', description = "aiVector3D*", },
    ["mFaces"] = { type ='value', description = "aiFace*", },
    ["mNumBones"] = { type ='value', description = "uint", },
    ["mBones"] = { type ='value', description = "aiBone**", },
    ["mMaterialIndex"] = { type ='value', description = "uint", },
    ["mName"] = { type ='value', description = "aiString", },
    ["mNumAnimMeshes"] = { type ='value', description = "uint", },
    ["mAnimMeshes"] = { type ='value', description = "aiAnimMesh**", },
    }
  },
  ["aiUVTransform"] = { type ='class', 
    description = "", 
    childs =     {
    ["mTranslation"] = { type ='value', description = "aiVector2D", },
    ["mScaling"] = { type ='value', description = "aiVector2D", },
    ["mRotation"] = { type ='value', description = "float", },
    }
  },
  ["aiMaterialProperty"] = { type ='class', 
    description = "", 
    childs =     {
    ["mKey"] = { type ='value', description = "aiString", },
    ["mSemantic"] = { type ='value', description = "uint", },
    ["mIndex"] = { type ='value', description = "uint", },
    ["mDataLength"] = { type ='value', description = "uint", },
    ["mType"] = { type ='value', description = "aiPropertyTypeInfo", },
    ["mData"] = { type ='value', description = "char*", },
    }
  },
  ["aiMaterial"] = { type ='class', 
    description = "", 
    childs =     {
    ["mProperties"] = { type ='value', description = "aiMaterialProperty**", },
    ["mNumProperties"] = { type ='value', description = "uint", },
    ["mNumAllocated"] = { type ='value', description = "uint", },
    }
  },
  ["aiTexel"] = { type ='class', 
    description = "", 
  ...
  ["aiTexture"] = { type ='class', 
    description = "", 
    childs =     {
    ["mWidth"] = { type ='value', description = "uint", },
    ["mHeight"] = { type ='value', description = "uint", },
    ["pcData"] = { type ='value', description = "aiTexel*", },
    }
  },
  ["aiNode"] = { type ='class', 
    description = "", 
    childs =     {
    ["mName"] = { type ='value', description = "aiString", },
    ["mTransformation"] = { type ='value', description = "aiMatrix4x4", },
    ["mParent"] = { type ='value', description = "struct aiNode*", },
    ["mNumChildren"] = { type ='value', description = "uint", },
    ["mChildren"] = { type ='value', description = "struct aiNode**", },
    ["mNumMeshes"] = { type ='value', description = "int", },
    ["mMeshes"] = { type ='value', description = "uint*", },
    }
  },
  ["aiScene"] = { type ='class', 
    description = "", 
    childs =     {
    ["mFlags"] = { type ='value', description = "uint", },
    ["mRootNode"] = { type ='value', description = "aiNode*", },
    ["mNumMeshes"] = { type ='value', description = "uint", },
    ["mMeshes"] = { type ='value', description = "aiMesh**", },
    ["mNumMaterials"] = { type ='value', description = "uint", },
    ["mMaterials"] = { type ='value', description = "aiMaterial**", },
    ["mNumAnimations"] = { type ='value', description = "uint", },
    ["mAnimations"] = { type ='value', description = "aiAnimation**", },
    ["mNumTextures"] = { type ='value', description = "uint", },
    ["mTextures"] = { type ='value', description = "aiTexture**", },
    ["mNumLights"] = { type ='value', description = "uint", },
    ["mLights"] = { type ='value', description = "aiLight**", },
    ["mNumCameras"] = { type ='value', description = "uint", },
    ["mCameras"] = { type ='value', description = "aiCamera**", },
    }
  },
  }
return {
