...
local api = {
  ...
  ["CU_CTX_SCHED_AUTO"] = { type ='keyword', },
  ["CU_CTX_SCHED_SPIN"] = { type ='keyword', },
  ["CU_CTX_SCHED_YIELD"] = { type ='keyword', },
  ["CU_CTX_SCHED_MASK"] = { type ='keyword', },
  ["CU_CTX_BLOCKING_SYNC"] = { type ='keyword', },
  ["CU_CTX_MAP_HOST"] = { type ='keyword', },
  ["CU_CTX_LMEM_RESIZE_TO_MAX"] = { type ='keyword', },
  ["CU_CTX_FLAGS_MASK"] = { type ='keyword', },
  ["CU_EVENT_DEFAULT"] = { type ='keyword', },
  ["CU_EVENT_BLOCKING_SYNC"] = { type ='keyword', },
  ["CU_EVENT_DISABLE_TIMING"] = { type ='keyword', },
  ["CU_AD_FORMAT_UNSIGNED_INT8"] = { type ='keyword', },
  ["CU_AD_FORMAT_UNSIGNED_INT16"] = { type ='keyword', },
  ["CU_AD_FORMAT_UNSIGNED_INT32"] = { type ='keyword', },
  ["CU_AD_FORMAT_SIGNED_INT8"] = { type ='keyword', },
  ["CU_AD_FORMAT_SIGNED_INT16"] = { type ='keyword', },
  ["CU_AD_FORMAT_SIGNED_INT32"] = { type ='keyword', },
  ["CU_AD_FORMAT_HALF"] = { type ='keyword', },
  ["CU_AD_FORMAT_FLOAT"] = { type ='keyword', },
  ["CU_TR_ADDRESS_MODE_WRAP"] = { type ='keyword', },
  ["CU_TR_ADDRESS_MODE_CLAMP"] = { type ='keyword', },
  ["CU_TR_ADDRESS_MODE_MIRROR"] = { type ='keyword', },
  ["CU_TR_ADDRESS_MODE_BORDER"] = { type ='keyword', },
  ["CU_TR_FILTER_MODE_POINT"] = { type ='keyword', },
  ["CU_TR_FILTER_MODE_LINEAR"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_THREADS_PER_BLOCK"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_X"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Y"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Z"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_X"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_Y"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_Z"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_SHARED_MEMORY_PER_BLOCK"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_SHARED_MEMORY_PER_BLOCK"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_TOTAL_CONSTANT_MEMORY"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_WARP_SIZE"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_PITCH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAX_REGISTERS_PER_BLOCK"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_REGISTERS_PER_BLOCK"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_CLOCK_RATE"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_TEXTURE_ALIGNMENT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_GPU_OVERLAP"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MULTIPROCESSOR_COUNT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_KERNEL_EXEC_TIMEOUT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_INTEGRATED"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_CAN_MAP_HOST_MEMORY"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_COMPUTE_MODE"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE1D_WIDTH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_WIDTH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_HEIGHT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_WIDTH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_HEIGHT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_DEPTH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_ARRAY_WIDTH"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_ARRAY_HEIGHT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_ARRAY_NUMSLICES"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_SURFACE_ALIGNMENT"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_CONCURRENT_KERNELS"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_ECC_ENABLED"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_PCI_BUS_ID"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_PCI_DEVICE_ID"] = { type ='keyword', },
  ["CU_DEVICE_ATTRIBUTE_TCC_DRIVER"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_MAX_THREADS_PER_BLOCK"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_SHARED_SIZE_BYTES"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_CONST_SIZE_BYTES"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_LOCAL_SIZE_BYTES"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_NUM_REGS"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_PTX_VERSION"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_BINARY_VERSION"] = { type ='keyword', },
  ["CU_FUNC_ATTRIBUTE_MAX"] = { type ='keyword', },
  ["CU_FUNC_CACHE_PREFER_NONE"] = { type ='keyword', },
  ["CU_FUNC_CACHE_PREFER_SHARED"] = { type ='keyword', },
  ["CU_FUNC_CACHE_PREFER_L1"] = { type ='keyword', },
  ["CU_MEMORYTYPE_HOST"] = { type ='keyword', },
  ["CU_MEMORYTYPE_DEVICE"] = { type ='keyword', },
  ["CU_MEMORYTYPE_ARRAY"] = { type ='keyword', },
  ["CU_COMPUTEMODE_DEFAULT"] = { type ='keyword', },
  ["CU_COMPUTEMODE_EXCLUSIVE"] = { type ='keyword', },
  ["CU_COMPUTEMODE_PROHIBITED"] = { type ='keyword', },
  ["CU_JIT_MAX_REGISTERS"] = { type ='keyword', },
  ["CU_JIT_THREADS_PER_BLOCK"] = { type ='keyword', },
  ["CU_JIT_WALL_TIME"] = { type ='keyword', },
  ["CU_JIT_INFO_LOG_BUFFER"] = { type ='keyword', },
  ["CU_JIT_INFO_LOG_BUFFER_SIZE_BYTES"] = { type ='keyword', },
  ["CU_JIT_ERROR_LOG_BUFFER"] = { type ='keyword', },
  ["CU_JIT_ERROR_LOG_BUFFER_SIZE_BYTES"] = { type ='keyword', },
  ["CU_JIT_OPTIMIZATION_LEVEL"] = { type ='keyword', },
  ["CU_JIT_TARGET_FROM_CUCONTEXT"] = { type ='keyword', },
  ["CU_JIT_TARGET"] = { type ='keyword', },
  ["CU_JIT_FALLBACK_STRATEGY"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_10"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_11"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_12"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_13"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_20"] = { type ='keyword', },
  ["CU_TARGET_COMPUTE_21"] = { type ='keyword', },
  ["CU_PREFER_PTX"] = { type ='keyword', },
  ["CU_PREFER_BINARY"] = { type ='keyword', },
  ["CU_GRAPHICS_REGISTER_FLAGS_NONE"] = { type ='keyword', },
  ["CU_GRAPHICS_MAP_RESOURCE_FLAGS_NONE"] = { type ='keyword', },
  ["CU_GRAPHICS_MAP_RESOURCE_FLAGS_READ_ONLY"] = { type ='keyword', },
  ["CU_GRAPHICS_MAP_RESOURCE_FLAGS_WRITE_DISCARD"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_POSITIVE_X"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_NEGATIVE_X"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_POSITIVE_Y"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_NEGATIVE_Y"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_POSITIVE_Z"] = { type ='keyword', },
  ["CU_CUBEMAP_FACE_NEGATIVE_Z"] = { type ='keyword', },
  ["CU_LIMIT_STACK_SIZE"] = { type ='keyword', },
  ["CU_LIMIT_PRINTF_FIFO_SIZE"] = { type ='keyword', },
  ["CU_LIMIT_MALLOC_HEAP_SIZE"] = { type ='keyword', },
  ["CUDA_SUCCESS"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_VALUE"] = { type ='keyword', },
  ["CUDA_ERROR_OUT_OF_MEMORY"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_INITIALIZED"] = { type ='keyword', },
  ["CUDA_ERROR_DEINITIALIZED"] = { type ='keyword', },
  ["CUDA_ERROR_NO_DEVICE"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_DEVICE"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_IMAGE"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_CONTEXT"] = { type ='keyword', },
  ["CUDA_ERROR_CONTEXT_ALREADY_CURRENT"] = { type ='keyword', },
  ["CUDA_ERROR_MAP_FAILED"] = { type ='keyword', },
  ["CUDA_ERROR_UNMAP_FAILED"] = { type ='keyword', },
  ["CUDA_ERROR_ARRAY_IS_MAPPED"] = { type ='keyword', },
  ["CUDA_ERROR_ALREADY_MAPPED"] = { type ='keyword', },
  ["CUDA_ERROR_NO_BINARY_FOR_GPU"] = { type ='keyword', },
  ["CUDA_ERROR_ALREADY_ACQUIRED"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_MAPPED"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_MAPPED_AS_ARRAY"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_MAPPED_AS_POINTER"] = { type ='keyword', },
  ["CUDA_ERROR_ECC_UNCORRECTABLE"] = { type ='keyword', },
  ["CUDA_ERROR_UNSUPPORTED_LIMIT"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_SOURCE"] = { type ='keyword', },
  ["CUDA_ERROR_FILE_NOT_FOUND"] = { type ='keyword', },
  ["CUDA_ERROR_SHARED_OBJECT_SYMBOL_NOT_FOUND"] = { type ='keyword', },
  ["CUDA_ERROR_SHARED_OBJECT_INIT_FAILED"] = { type ='keyword', },
  ["CUDA_ERROR_OPERATING_SYSTEM"] = { type ='keyword', },
  ["CUDA_ERROR_INVALID_HANDLE"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_FOUND"] = { type ='keyword', },
  ["CUDA_ERROR_NOT_READY"] = { type ='keyword', },
  ["CUDA_ERROR_LAUNCH_FAILED"] = { type ='keyword', },
  ["CUDA_ERROR_LAUNCH_OUT_OF_RESOURCES"] = { type ='keyword', },
  ["CUDA_ERROR_LAUNCH_TIMEOUT"] = { type ='keyword', },
  ["CUDA_ERROR_LAUNCH_INCOMPATIBLE_TEXTURING"] = { type ='keyword', },
  ["CUDA_ERROR_UNKNOWN"] = { type ='keyword', },
  ["CU_MEMHOSTALLOC_PORTABLE"] = { type ='keyword', },
  ["CU_MEMHOSTALLOC_DEVICEMAP"] = { type ='keyword', },
  ["CU_MEMHOSTALLOC_WRITECOMBINED"] = { type ='keyword', },
  ["CUDA_ARRAY3D_2DARRAY"] = { type ='keyword', },
  ["CUDA_ARRAY3D_SURFACE_LDST"] = { type ='keyword', },
  ["CU_TRSA_OVERRIDE_FORMAT"] = { type ='keyword', },
  ["CU_TRSF_READ_AS_INTEGER"] = { type ='keyword', },
  ["CU_TRSF_NORMALIZED_COORDINATES"] = { type ='keyword', },
  ["CU_TRSF_SRGB"] = { type ='keyword', },
  ["CU_PARAM_TR_DEFAULT"] = { type ='keyword', },
