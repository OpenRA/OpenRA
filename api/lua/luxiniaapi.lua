...
",childs={}}
blendmode = {type='class',description="They define how texels or pixels are blend with the destination. Sometimes you might be able to use inverted blends, those just invert the self.alpha value",childs={["decal"] = {type='function', description = " out = destination * (1-self.alpha) + self * (self.alpha)", args="()", returns="(blendmode)"},
...
["sub"] = {type='function', description = " out = self - destination.", args="()", returns="(blendmode)"},
