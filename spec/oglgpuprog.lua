return {
	...
	keywords = {
		...
		SCS SEQ SFL SGE SGT SHL SHR SIN SLE SLT SNE SSG STR SUB SWZ TEX TRUNC
		TXB TXD TXF TXL TXP TXQ UP2H UP2US UP4B UP4UB X2D XOR XPD 
		...
		ATTRIB PARAM TEMP ADDRESS OUTPUT ALIAS OPTION 
