				...
				case "TeamChat":
					{
						...
						if (client != null)
						{
							...
							else
							{
								...
								if ((world.LocalPlayer != null && player.Stances[world.LocalPlayer].Intersects(Stance.Ally)) || player.WinState == WinState.Lost)
								{
				...
				case "SetStance":
					{
						...
						if (newStance == Stance.Enemy && targetPlayer.Stances[order.Player].Intersects(Stance.Ally))
						{
