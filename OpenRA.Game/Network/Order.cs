	...
	public sealed class Order
	{
		...
		public static Order Deserialize(World world, BinaryReader r)
		{
			...
			catch (Exception e)
			{
				...
				TextManager.Debug("Ignoring malformed order that would have crashed the game");
				TextManager.Debug("Please file a bug report and include the replay from this match");
