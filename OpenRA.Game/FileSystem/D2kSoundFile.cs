...
{
	public class D2kSoundFileLoader : IPackageLoader
	{
		public sealed class D2kSoundFile : IReadOnlyPackage
		{
			struct Entry
			{
			...
			public D2kSoundFile(FileSystem context, string filename)
			{
				Name = filename;
		...
		public bool TryParsePackage(FileSystem context, string filename, out IReadOnlyPackage package)
		{
			...
			package = new D2kSoundFile(context, filename);
			return true;
		}
	}
}
