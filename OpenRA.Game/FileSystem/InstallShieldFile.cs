...
{
	public class InstallShieldFileLoader : IPackageLoader
	{
		public sealed class InstallShieldFile : IReadOnlyPackage
		{
			public struct Entry
			{
			...
			public InstallShieldFile(FileSystem context, string filename)
			{
				Name = filename;
		...
		public bool TryParsePackage(FileSystem context, string filename, out IReadOnlyPackage package)
		{
			...
			package = new InstallShieldFile(context, filename);
			return true;
		}
	}
}
