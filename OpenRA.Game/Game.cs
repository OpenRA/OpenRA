...
namespace OpenRA
{
	public static class Game
	{
		...
		internal static void Initialize(Arguments args)
		{
			...
			{
				if (r == null)
					throw new InvalidOperationException("No suitable renderers were found. Check " + Log.LoggingChannel.Graphics + ".log for details.");
				...
				catch (Exception e)
				{
					...
					Console.WriteLine("Renderer initialization failed. Fallback in place. Check " + Log.LoggingChannel.Graphics + ".log for details.");
				}
			}
			...
			catch (Exception e)
			{
				...
				Console.WriteLine("Creating the sound engine failed. Fallback in place. Check " + Log.LoggingChannel.Sound + ".log for details.");
