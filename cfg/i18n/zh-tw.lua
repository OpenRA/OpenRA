return {
  ...
  ["&About"] = "關於(&A)", -- src\editor\menu_help.lua
  ["&Add Watch"] = "新增監視(&A)", -- src\editor\debugger.lua
  ...
  ["Binary file is shown as read-only as it is only partially loaded."] = "二進位文件被標示為唯讀由於只能部分載入", -- src\editor\commands.lua
  ...
  ["Can't process auto-recovery record; invalid format: %s."] = "無法處理自動還原存檔; 無效的格式: %s", -- src\editor\commands.lua
  ["Can't replace in read-only text."] = "無法取代唯讀屬性的文本", -- src\editor\findreplace.lua
  ...
  ["Can't start debugging for '%s'."] = "無法啟動除錯到 '%s'.", -- src\editor\debugger.lua
  ["Can't start debugging session due to internal error '%s'."] = "無法啟動除錯session由於內部錯誤 '%s'.", -- src\editor\debugger.lua
  ["Can't start debugging without an opened file or with the current file not being saved ('%s')."] = "無法啟動除錯，沒有檔案被開啟或目前的檔案尚未儲存('%s')", -- src\editor\debugger.lua
  ...
  ["Choose a project directory"] = "選取一個專案目錄", -- src\editor\toolbar.lua, src\editor\menu_project.lua, src\editor\filetree.lua
  ["Choose a search directory"] = "選取一個搜尋目錄", -- src\editor\findreplace.lua
  ...
  ["Close the current editor window"] = "關閉目前的編輯視窗", -- src\editor\menu_file.lua
  ...
  ["Command line parameters"] = "命令列參數", -- src\editor\menu_project.lua
  ["Comment or uncomment current or selected lines"] = "註解/取消註解目前或選擇的行", -- src\editor\menu_edit.lua
  ["Compilation error"] = "編譯錯誤", -- src\editor\commands.lua, src\editor\debugger.lua
  ["Compilation successful; %.0f%% success rate (%d/%d)."] = "編譯成功; 成功率: %.0f%% (%d/%d).", -- src\editor\commands.lua
  ["Compile the current file"] = "編譯目前的檔案", -- src\editor\menu_project.lua
  ...
  ["Copy selected text to clipboard"] = "複製選擇的文本到剪貼簿", -- src\editor\menu_edit.lua
  ...
  ["Cut selected text to clipboard"] = "剪下選擇的文本到剪貼簿", -- src\editor\menu_edit.lua
  ...
  ["Debugging session started in '%s'."] = "除錯session於 '%s' 啟動", -- src\editor\debugger.lua
  ...
  ["Do you want to save the changes to '%s'?"] = "你是否儲存修改到 '%s'?", -- src\editor\commands.lua
  ["E&xit"] = "結束", -- src\editor\menu_file.lua
  ["Enable Indexing"] = "啟用索引", -- src\editor\outline.lua
  ["Enter Lua code and press Enter to run it."] = "輸入Lua程式碼後按下Enter來執行", -- src\editor\shellbox.lua
  ...
  ["Execute the current project/file and keep updating the code to see immediate results"] = "執行目前的專案/檔案並更新程式碼以得到執行結果", -- src\editor\menu_project.lua
  ["Execute the current project/file"] = "執行目前的專案/檔案", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ...
  ["File '%s' has more recent timestamp than restored '%s'; please review before saving."] = "檔案 '%s' 的時間戳比 '%s' 新; 儲存前請檢察", -- src\editor\commands.lua
  ...
  ["Find and replace text in files"] = "尋找並取代文本於檔案", -- src\editor\menu_search.lua
  ["Find and replace text"] = "尋找與取代", -- src\editor\toolbar.lua, src\editor\menu_search.lua
  ...
  ["Find the earlier text occurence"] = "尋找之前出現的文本", -- src\editor\menu_search.lua
  ["Find the next text occurrence"] = "尋找之後出現的文本", -- src\editor\menu_search.lua
  ...
  ["Found %d instance."] = "找到 %d 實例", -- src\editor\findreplace.lua
  ["Found auto-recovery record and restored saved session."] = "找到自動還原存檔並恢復儲存的session", -- src\editor\commands.lua
  ...
  ["Go To Line..."] = "前往...行", -- src\editor\menu_search.lua
  ...
  ["Ignore and don't index symbols from files in the selected directory"] = "忽略並不要符號索引在選擇的目錄中的檔案", -- src\editor\outline.lua
  ["Ignored error in debugger initialization code: %s."] = "忽略在除錯器初始化程式碼的錯誤 %s.", -- src\editor\debugger.lua
  ["Indexing %d files: '%s'..."] = "索引 %d 檔案： '%s'...", -- src\editor\outline.lua
  ...
  ["Preferences"] = "編號設定", -- src\editor\menu_edit.lua
  ...
  ["Program can't start because conflicting process is running as '%s'."] = "程式無法啟動由於衝突程序 '%s'", -- src\editor\output.lua
  ...
  ["Queued %d files to index."] = "佇列 %d 檔案到索引", -- src\editor\menu_search.lua
  ["R/O"] = "唯讀", -- src\editor\editor.lua
  ["R/W"] = "讀寫", -- src\editor\editor.lua
  ["Re&place In Files"] = "在檔案中取代", -- src\editor\menu_search.lua
  ["Re-indent selected lines"] = "重新縮排選擇的行", -- src\editor\menu_edit.lua
  ["Reached end of selection and wrapped around."] = "到達選擇的文本底部wrapped around", -- src\editor\findreplace.lua
  ["Reached end of text and wrapped around."] = "到達文本底部並wrapped around", -- src\editor\findreplace.lua
  ["Recent Files"] = "近期檔案", -- src\editor\menu_file.lua
  ["Recent Projects"] = "近期專案", -- src\editor\menu_file.lua
  ["Redo last edit undone"] = "重做最後被取消的編輯", -- src\editor\menu_edit.lua
  ["Refresh Index"] = "刷新索引", -- src\editor\outline.lua
  ["Refresh indexed symbols from files in the selected directory"] = "刷新選擇的目錄的符號索引", -- src\editor\outline.lua
  ["Refresh"] = "刷新", -- src\editor\filetree.lua
  ["Refused a request to start a new debugging session as there is one in progress already."] = "拒絕啟動新的除錯session由於已經存在一個進行中的", -- src\editor\debugger.lua
  ...
  ["Saved auto-recover at %s."] = "儲存自動還原到 %s", -- src\editor\commands.lua
  ["Scratchpad error"] = "Scratchpad錯誤", -- src\editor\debugger.lua
  ["Search direction"] = "搜尋方向", -- src\editor\toolbar.lua
  ["Search in selection"] = "搜尋選擇項目", -- src\editor\toolbar.lua
  ["Search in subdirectories"] = "搜尋子目路", -- src\editor\toolbar.lua
  ...
  ["Select the word under cursor and find its next occurrence"] = "選擇由雕下的單字並尋找下一個", -- src\editor\menu_search.lua
  ["Select the word under cursor and find its previous occurrence"] = "選擇由雕下的單字並尋找上一個", -- src\editor\menu_search.lua
  ...
  ["Set To Selected Directory"] = "設定到選擇的目錄", -- src\editor\filetree.lua
  ["Set project directory from current file"] = "從目前檔案設定專案目錄", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ["Set project directory to the selected one"] = "設定專案目錄成選擇的", -- src\editor\filetree.lua
  ...
  ["Show all files"] = "顯示所有檔案", -- src\editor\filetree.lua
  ["Show context"] = "顯示context", -- src\editor\toolbar.lua
  ["Show files previously hidden"] = "顯示之前隱藏的檔案", -- src\editor\filetree.lua
  ...
  ["Sort selected lines"] = "排序選擇的行", -- src\editor\menu_edit.lua
  ["Source"] = "來源", -- src\editor\menu_edit.lua
  ["Stack"] = "堆疊", -- src\editor\debugger.lua
  ["Start &Debugging"] = "啟動除錯", -- src\editor\menu_project.lua
  ["Start or continue debugging"] = "啟動繼續除錯", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ...
  ["Stop debugging and continue running the process"] = "停止除錯並繼續程序", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ...
  ["Text not found."] = "尋找不到文本", -- src\editor\findreplace.lua
  ...
  ["Updated %d file."] = "更新 %d 檔案", -- src\editor\findreplace.lua
  ["Updating symbol index and settings..."] = "更新符號索引與設定...", -- src\editor\outline.lua
  ["Use %s to close."] = "使用 %s 來關閉", -- src\editor\findreplace.lua
  ["Use '%s' to see full description."] = "使用 '%s' 來看完整描述", -- src\editor\editor.lua
  ["Use '%s' to show line endings and '%s' to convert them."] = "用 '%s' 還顯示行尾並以 '%s' 來轉換", -- src\editor\commands.lua
