...
return {
  ...
  ["&Copy"] = "&Kopii", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ...
  ["&Paste"] = "&Alglui", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ["&Project Page"] = "&Projektpaĝo", -- src\editor\menu_help.lua
  ["&Project"] = "&Projekto", -- src\editor\inspect.lua, src\editor\menu_project.lua
  ["&Redo"] = "&Refari", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ...
  ["&Undo"] = "&Malfari", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ...
  ["Break execution at the next executed line of code"] = "Haltigi plenumon ĉe la sekva plenumata linio da fontkodo", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["C&lear Output Window"] = "Viŝi eligan fenestron", -- src\editor\menu_project.lua
  ...
  ["Choose a project directory"] = "Elekti projektan dosierujon", -- src\editor\findreplace.lua, src\editor\menu_project.lua, src\editor\gui.lua, src\editor\filetree.lua
  ...
  ["Copy Full Path"] = "Kopii plenan vojon", -- src\editor\filetree.lua
  ["Copy selected text to clipboard"] = "Kopii elektitan tekston al la tondejo", -- src\editor\menu_edit.lua
  ["Correct &Indentation"] = "Korekti &alineon", -- NOTE: added this entry
  ...
  ["Create an empty document"] = "Krei malplenan dokumenton", -- src\editor\gui.lua, src\editor\menu_file.lua
  ["Cu&t"] = "El&tondi", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ...
  ["Expr"] = "Espr", -- src\editor\debugger.lua
  ["Expression"] = "Esprimo", -- src\editor\debugger.lua
  ...
  ["Find and replace text"] = "Traserĉi kaj anstataŭi tekston", -- src\editor\gui.lua, src\editor\menu_search.lua
  ["Find text in files"] = "Traserĉi tekston en dosieroj", -- src\editor\menu_search.lua
  ["Find text"] = "Traserĉi tekston", -- src\editor\gui.lua, src\editor\menu_search.lua
  ...
  ["Jump to a function definition..."] = "Salti al funkcideklaro...", -- src\editor\editor.lua
  ...
  ["Open an existing document"] = "Malfermi jaman dokumenton", -- src\editor\gui.lua, src\editor\menu_file.lua
  ["Open file"] = "Malfermi dosieron", -- src\editor\commands.lua
  ["Options"] = "Opcioj", -- src\editor\findreplace.lua
  ["Output (running)"] = "Eligo (funkciata)", -- src\editor\output.lua
  ["Output"] = "Eligo", -- src\editor\gui.lua, src\editor\output.lua, src\editor\settings.lua
  ...
  ["Prepend '!' to force local execution."] = "Antaŭdoni je '!' por altrudi lokan plenumon.", -- NOTE: added this entry
  ...
  ["Project"] = "Projekto", -- src\editor\gui.lua
  ...
  ["Save all open documents"] = "Konservi ĉiujn malfermajn dokumentojn", -- src\editor\gui.lua, src\editor\menu_file.lua
  ...
  ["Save the current document"] = "Konservi la kurantan dokumenton", -- src\editor\gui.lua, src\editor\menu_file.lua
  ...
  ["Select &All"] = "Elekti &ĉion", -- src\editor\menu_edit.lua, src\editor\editor.lua
  ...
  ["Set project directory from current file"] = "Precizigi la projektan dosierujon per la kurantan dosieron", -- src\editor\gui.lua, src\editor\menu_project.lua
  ...
  ["Source"] = "Fontkodo", -- NOTE: added this entry
  ["Stack"] = "Stako", -- src\editor\debugger.lua, src\editor\gui.lua
  ["Start &Debugging"] = "Ek-&sencimigi", -- src\editor\menu_project.lua
  ["Start or Continue debugging"] = "Komenci aŭ pluigi sencimigon", -- src\editor\gui.lua
  ...
  ["Step into"] = "Eniri enen", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["Step out of the current function"] = "Eliri el la kuranta funkcio", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["Step over"] = "Transsalti", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["Stop debugging and continue running the process"] = "Fini sencimigon kaj plenumadi la procezon", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["Stop the currently running process"] = "Fini la nunfunkciatan procezon", -- src\editor\gui.lua, src\editor\menu_project.lua
  ...
  ["Value"] = "Valoro", -- src\editor\debugger.lua
  ...
  ["View the stack window"] = "Vidi la stako-fenestron", -- src\editor\gui.lua, src\editor\menu_view.lua
  ["View the watch window"] = "Vidi la observado-fenestron", -- src\editor\gui.lua, src\editor\menu_view.lua
  ["Watch"] = "Observado", -- src\editor\debugger.lua, src\editor\gui.lua
